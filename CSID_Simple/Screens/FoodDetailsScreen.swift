                                        ...
                                        HStack {
                                            ZStack {
                                                ...
                                                Circle()
                                                    ...
                                                    .stroke(.iconYellow, lineWidth: selectedToleration == .some ? 35 : 30)
                                                    .frame(width: geometry.size.width * 0.33)
                                                    .onTapGesture {
                                                ...
                                                Circle()
                                                    ...
                                                    .stroke(.iconTeal, lineWidth: selectedToleration == .most ? 35 : 30)
                                                    .frame(width: geometry.size.width * 0.33)
                                                    .onTapGesture {
...
//    func tolerationMockData() -> [TolerationRating_Local] {
//        var foodRatings: [TolerationRating_Local] = []
//        let ratingOptions: [Float] = [0.0, 1.5, 3.0]
//        
//        for i in 1...8 {
//            foodRatings.append(TolerationRating_Local(fdicID: 1996763, rating: ratingOptions.randomElement() ?? 1.5, comment: "If I take sucraid then I can handle a couple bites of this tasty treat.  Otherwise, it hurts my belly.", userID: "vmuller2529", timestamp: Date.now))
//        }
//        
        ...
        do {
            ...
            case .success(let ratings):
                ...
                for r in ratings {
                    ...
                    if r.rating == "0.0" {
                        tolerationChunks.notTolerable.append(r)
                    } else if r.rating == "1.5" {
                        tolerationChunks.somewhatTolerable.append(r)
                    } else {
                        tolerationChunks.tolerable.append(r)
                    }
                }
