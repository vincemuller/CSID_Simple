...
//  CSID_Simple
//
//  Created by Vince Muller on 1/17/25.
//
...
struct ConsumptionCircle: View {
            ...
            ZStack {
                ...
                if self.getShowShadow(frame: geometry.size) {
                    Circle()
                        ...
                        .shadow(color: ConsumptionCircle.ShadowColor,
                                radius: ConsumptionCircle.ShadowRadius,
    ...
    private func getEndCircleShadowOffset() -> (CGFloat, CGFloat) {
        ...
        let xOffset = relativeXOffset.toCGFloat() * ConsumptionCircle.ShadowOffsetMultiplier
        let yOffset = relativeYOffset.toCGFloat() * ConsumptionCircle.ShadowOffsetMultiplier
